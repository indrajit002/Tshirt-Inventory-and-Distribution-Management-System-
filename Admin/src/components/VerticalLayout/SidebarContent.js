          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li><Link to="/dashboard">{props.t("T-shirt Dashboard")} 1</Link></li>
            ...
            <li>
              <Link to="/#" className="has-arrow waves-effect">
                <i className="mdi mdi-inbox-full"></i>
                <span>{props.t("Delevery Report")}</span>
              </Link>
              <ul className="sub-menu">
                <li>  
                  <Link to="/Student Delevery Report">{props.t("Student Delevery Report")}</Link>
                </li>
                <li>
                  <Link to="/Manufacture Delevery Report">{props.t("Manufacture Delevery Report")} </Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
              <Link to="/#">{props.t("studentreport")}</Link>
                </li>
                <li>
                  <Link to="/#" className="has-arrow">
                    {props.t("studentreport")}
                  </Link>
                  <ul className="sub-menu">
                    <li>
                      <Link to="/#">{props.t("manifacturereport")}</Link>
                    </li>
                    <li>
                      <Link to="/#">{props.t("manifacturereport")}</Link>
                    </li>
